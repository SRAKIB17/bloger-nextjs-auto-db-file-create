            ...
            <form onSubmit={savePostThemeHandle}>
                ...
                <div className=" m-6 flex flex-col gap-4">
                    ...
                    <div className='flex gap-3 flex-col'>
                        ...
                        <div className='ml-4'>
                            <img src='/settings/post/theme/default.png' alt="" className='max-w-md border rounded-sm h-full' />
                        </div>
                    </div>
                    ...
                    <div className='flex gap-3 flex-col'>
                        ...
                        <div className='ml-4'>
                            <img src='/settings/post/theme/post with body.png' alt="" className='max-w-md border rounded-sm h-full' />
                        </div>
                    </div>
