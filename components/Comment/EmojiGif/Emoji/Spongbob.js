...
const Spongbob = ({ props: { selectEmoji, setSelectEmoji } }) => {
    const selectEmojiHandle = (path) => {
        setSelectEmoji(path)
    }

    const cache = []
    const getM = require.context('../../../../public/emojis/spongbob', true, /\.(webp|html|js|css|gif|png)$/, 'sync');
