...
const FunnyBaby = ({ props: { selectEmoji, setSelectEmoji } }) => {
    ...
    const cache = []
    const getM = require.context('../../../../public/emojis/funny_baby', true, /\.(webp|html|js|css|gif|png)$/, 'sync');
