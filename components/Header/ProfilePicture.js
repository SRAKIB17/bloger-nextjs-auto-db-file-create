        ...
        <div>
            <div>
                <ul className="menu menu-horizontal p-0 flex items-center md:absolute md:right-0 md:top-0">
                    ...
                    <li>
                        <button onMouseEnter={ProfilePictureHandle} >
            ...
            <div className='border border-double onClickProfileMenu right-0 bg-base-100 mt-[-100px] rounded-b-lg shadow-2xl' id='profileLogOut'>
                <div className='p-3'>
