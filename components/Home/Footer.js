...
const Footer = () => {
    return (
        <section className="w-full relative">
            {/* <div classNameName='relative top-0'>
                <img src={FooterBg?.src} alt="" classNameName='w-full absolute top-0 h-60' />
            </div> */}
            ...
            <footer className="footer px-10 justify-center py-4 md:pb-10 border-t bg-base-200 text-base-content border-base-300">
